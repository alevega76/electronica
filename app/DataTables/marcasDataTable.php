...
class marcasDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return (new EloquentDataTable($query))
            ...
            */
            ...
            ->addColumn('action', function($row){
                $actionBtn = '<a  href="/marcas/'. $row->idMarca .'/edit" class="btn btn-success btn-sm">Editar</a>';
                $actionBtn = $actionBtn.' <a action="javascript:void(0)" href="#" data-id="'.$row->idMarca.'" data-action="" class="btn btn-danger btn-sm" onclick="deleteConfirmation(event);">Borrar</a>';
    ...
    public function getColumns(): array
    {
        return [
                  ...
                  Column::make('idMarca'),
                  Column::make('CodMarca'),
                  Column::make('NomMarca'),            
