...
class RepararCreateRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'CodRepar' => 'numeric|required|unique:reparar',
            ...
            'Intervencion' => 'string|max:2000',
            'CodInterv' => 'numeric',
            'CodOpcion' => 'string|max:1',
            'FueraZona' => 'string',
            'Garantia' => 'string',
            'FecConsulta' => 'date|date_format:Y-m-d',
            'FecOk' => 'date|date_format:Y-m-d',
            'FecSalida' => 'date|date_format:Y-m-d',
