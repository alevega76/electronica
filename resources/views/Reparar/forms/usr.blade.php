...
<div class='d-flex flex-wrap'>
	<div class="form-group flex-grow-1">
		...
		<textarea   id="Intervencion" name="Intervencion" class="form-control" rows="3" placeholder="Intervencion...">{{ old('Intervencion', $reparar->Intervencion)}}</textarea>
		@error('Intervencion')
   		   <span class="text-danger ">{{ $message }}</span>
	    @enderror		 
	</div>
...
<div class='d-flex flex-wrap justify-content-between'>
	...
	<div class="form-group fixed-width">
		...
		<div class="input-group date" id="FecSalida" data-target-input="nearest">
			<input type="text" class="form-control datepicker" name="FecSalida" data-target="#FecSalida"
			value='{{ old('FecSalida', optional($reparar->FecSalida)->format('d/m/Y')) }}'
			/>
			<div class="input-group-append" data-target="#fechaconsulta" data-toggle="datepicker">
				<div class="input-group-text"><i class="fa fa-calendar"></i></div>
			</div>
	...
	<div class="form-group fixed-width">
		<label>Fecha de OK:</label>
		<div class="input-group date" id="FecOk" data-target-input="nearest">
			<input type="text" class="form-control datepicker" name="FecOk" data-target="#FecOk"
			value='{{ old('FecOk', optional($reparar->FecOk)->format('d/m/Y')) }}'
			/>
			<div class="input-group-append" data-target="#FecOk" data-toggle="datepicker">
				<div class="input-group-text"><i class="fa fa-calendar"></i></div>
			</div>
			@error('FecOk')
					<span class="text-danger ">{{ $message }}</span>
	...
	<div class='form-group flex-grow-1 tx-CodInterv-fixed-width'>
		<label>Cod de Interv :</label>
		 <div class='input-group' id="CodInterv" data-target-input="nearest">
			 <input type="text" name="CodInterv" class="form-control"
			 value="{{ old('CodInterv', $reparar->CodInterv)  }}"
			 />
		 </div>
		 @error('CodInterv')
      				<span class="text-danger ">{{ $message }}</span>
...
*/
	   $(
		'#FecEntrada,#FecCompra,#FecConsulta,#FecSalida,#FecOk'
		).datepicker(
	   {
		format: 'dd/mm/yyyy',
		language: 'es'
