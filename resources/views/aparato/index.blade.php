        ...
        @include('alerts.success')
				...
				<div class="card card-primary m-5"  style="width: 50rem;" >
						<div class="card-header">
							<h3 class="card-title">Listado de Aparatos</h3>
						</div>
						<!-- /.card-header -->
						<div class="card-body">
				...
				<table id="data-table" class="display nowrap table table-bordered data-table" cellspacing="0" width="100%">
						...
						<div class="card-footer">
							  <a class="btn btn-primary" href="{{ route('aparato.create') }}">Agregar Aparato</a>
                		</div>
						<!-- /.card-body -->
				</div>
...
<script type="text/javascript">
    ...
    function deleteConfirmation(e) {
      console.log(e);
               // e.preventDefault();
                var url =  '{{ route("aparato.destroy", ":id") }}';
    ...
    */
    ...
    $(document).ready(function() {
        ...
        var table = $('.data-table').DataTable({
            ...
            autoWidth: false,
            */
            ajax: "{{ route('aparato.index') }}",
            columns: [
                {data: 'idAparato', name: 'idAparato'},
                {data: 'CodAparato', name: 'CodAparato'},
                {data: 'NomAparato', name: 'NomAparato'},
